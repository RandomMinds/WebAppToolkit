...
var appDef = '{' +
                  '"Name":"ACT II",' +
                  '"Description":"Welcome to ACTII<br />Community and Economic Development\'s<br />Contact Management System",' +
                          ...
                          '"panels":' +
                            '[' +
                                ...
                                '{' +
                                    '"ID":"codes",' +
                                    '"Text":"&nbsp;&nbsp;Other",' +
                                    '"Description":"Manage system codes here.",' +
                                    '"panels":' +
                                    '[' +
                                        '{' +
                                            '"ID":"users",' +
                              ...
                              '{' +
                                '"data":' +
                                  '[' +
                                      '{' +
                                          '"width":"11em",' +
                                          '"template":"[SBPPLACCTMGRID@PPLUSER,USERID,LASTNAME,]"' +
                                      '},' +
                                      '{' +
                                          '"width":"11em",' +
