/* Example
	<script type="text/javascript">
		...
		SimpleContextMenu.attach('contextmenuable', 'CM1');
		SimpleContextMenu.attach('text_contextmenuable', 'CM2');
	</script>

	<ul id="CM1" class="SimpleContextMenu" >
	    <li><span onclick="dosomejavascript();">Do Something</li>
	    <li><span>With a sub menu</span>
	        <ul class="SimpleContextMenu" style="height: 200px; overflow: scroll;">
	            <li><span><a href="http://lvfc.org">LVFC</a></span></li>
	        </ul>
	</ul>
...
var SimpleContextMenu = {
	...
	setup : function (conf) {
		...
		if ( SimpleContextMenu.IE || SimpleContextMenu.FF ) {
            ...
            if (window.addEventListener) { //DOM method for binding an event
                document.addEventListener("contextmenu", SimpleContextMenu._show, true);
                document.addEventListener("click", SimpleContextMenu._hide, true);
            } else if (window.attachEvent) { //IE exclusive method for binding an event
                document.attachEvent("oncontextmenu", SimpleContextMenu._show);
                document.attachEvent("onclick", SimpleContextMenu._hide);
	...
	_hide : function () {
		...
		if (SimpleContextMenu._menuElement) {
            ...
            //SimpleContextMenu._attachedElement.removeChild(SimpleContextMenu);
		}
